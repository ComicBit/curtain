if (typeof controlPanelInjected === 'undefined') {
  ...
  function attachEventListeners() {
    ...
    if (toggleImages && toggleBackgrounds && toggleVideos && toggleSvgs && closePanel) {
      ...
      console.error('Control panel elements not found for attaching event listeners.');
    }
  }

  function handleCheckboxChange() {
    mediaSettings.images = document.getElementById('toggle-images').checked;
    mediaSettings.backgrounds = document.getElementById('toggle-backgrounds').checked;
  ...
  function handleMediaSettings() {
    ...
    toggleMedia(document.querySelectorAll('video'), mediaSettings.videos, 'videos');
  ...
  function toggleBackgrounds(enable) {
    const elements = document.querySelectorAll('*:not(#control-panel):not(#control-panel *)');
  ...
  function restoreSettings() {
    chrome.storage.local.get(['rules'], (result) => {
      if (result.rules && result.rules[currentUrl]) {
        ...
        document.getElementById('toggle-backgrounds').checked = mediaSettings.backgrounds;
